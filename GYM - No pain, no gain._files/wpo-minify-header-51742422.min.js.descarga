...
_this.toggleClass('active-open')});$('#woovina-toolbar .overlay').click(function(){$('#woovina-toolbar-open').trigger('click')});var hidebar=$.cookie("hidebar");if(hidebar=='hidebar'){$('#copyright').html('© Copyright 2018 WooVina - All Rights Reserved - Powered by WooVina Theme.');$('#woovina-copyright > a').removeAttr('href');$('#woovina-copyright > a').removeAttr('target')}})})(jQuery);
